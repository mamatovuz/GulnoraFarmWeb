// Inline SVG ikonkalar — logoning monoliniyali uslubiga mos:
// hamma joyda bir xil 1.8 qalinlik va yumaloq uchlar (logodagi kabi).
const INK = '#262626'  // brend shkalasidagi eng to'q pog'ona
...
export const Instagram = ({ size = 18, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...S} {...p}>
    <rect x="2.5" y="2.5" width="19" height="19" rx="6.5" /><circle cx="12" cy="12" r="4.2" />
    <circle cx="17.4" cy="6.6" r="1.1" fill="currentColor" stroke="none" />
  </svg>
)

export const Shield = ({ size = 23, color = INK, ...p }) => (
...
export const Check = ({ size = 22, color = 'currentColor', sw = 1.8, ...p }) => (
...
export const Gear = ({ size = 23, color = INK, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
...
export const Users = ({ size = 23, color = INK, sw = 1.8, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round" {...p}>
...
export const Pill = ({ size = 26, color = INK, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
    <path d="M10.5 20.5a5 5 0 0 1-7-7l7-7a5 5 0 0 1 7 7z" /><path d="M8.5 8.5l7 7" />
  </svg>
)

export const Heart = ({ size = 26, color = INK, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
    <path d="M12 21s-7-4.6-9.2-8.4A5 5 0 0 1 12 6a5 5 0 0 1 9.2 6.6C19 16.4 12 21 12 21z" />
  </svg>
)

export const Activity = ({ size = 26, color = INK, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
    <path d="M3 12h4l2 6 4-12 2 6h6" />
  </svg>
)

export const Chat = ({ size = 26, color = INK, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
    <path d="M21 15a2 2 0 0 1-2 2H8l-4 4V6a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2z" />
  </svg>
)

export const Clock = ({ size = 17, color = '#9a9a9a', ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
    <circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" />
  </svg>
)

export const Info = ({ size = 17, color = '#b0b0b0', ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
