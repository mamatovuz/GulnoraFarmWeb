...
export const TR = {
  uz: {
    ...
    netBadgeNum: '19', netBadgeLabel: 'filial', netBadgeSub: 'Andijon viloyati boʻylab',
    ...
    aboutText: 'Gulnora Farm 2017-yilda birinchi dorixonadan boshlangan. Bugun biz Andijon viloyati boʻylab 19 ta filialga egamiz va har bir mijozga bir xil yuqori sifatli xizmat koʻrsatamiz.',
    aboutNum: '19', aboutNumLabel: 'faol filial',
    ...
    vacCardNew: 'Yangi vakansiya', vacApply: 'Ariza yuborish', vacOpenBot: 'quyidagi tugmani bosing — bot ochiladi va anketa boshlanadi',
    vacFPosition: 'Lavozim', vacFBranch: 'Filial', vacFCount: 'Kerakli xodim', vacFGender: 'Kimlar uchun',
    vacFShift: 'Smena', vacFTime: 'Ish vaqti', vacFExp: 'Tajriba', vacFSalary: 'Maosh', vacFReq: 'Talablar',
    vacGenderMale: 'Erkak', vacGenderFemale: 'Ayol', vacGenderAny: 'Farqi yoʻq', vacCountUnit: 'nafar',
    vacShiftDay: 'Kunduzgi smena', vacShiftNight: 'Kechki smena', vacShiftAny: 'Smena',
  ...
  ru: {
    promo: 'Более 19 филиалов в Андижанской области — Gulnora Farm рядом с вами',
    ...
    netBadgeNum: '19', netBadgeLabel: 'филиалов', netBadgeSub: 'в Андижанской области',
    ...
    aboutText: 'Gulnora Farm началась в 2017 году с первой аптеки. Сегодня это сеть из более чем 19 филиалов в Андижанской области, и каждому клиенту мы оказываем одинаково высокий уровень сервиса.',
    aboutNum: '19', aboutNumLabel: 'действующих филиалов',
    ...
    vacCardNew: 'Новая вакансия', vacApply: 'Отправить заявку', vacOpenBot: 'нажмите кнопку ниже — откроется бот и анкета',
    vacFPosition: 'Должность', vacFBranch: 'Филиал', vacFCount: 'Требуется', vacFGender: 'Для кого',
    vacFShift: 'Смена', vacFTime: 'Время работы', vacFExp: 'Опыт', vacFSalary: 'Зарплата', vacFReq: 'Требования',
    vacGenderMale: 'Мужчина', vacGenderFemale: 'Женщина', vacGenderAny: 'Не важно', vacCountUnit: 'чел.',
    vacShiftDay: 'Дневная смена', vacShiftNight: 'Вечерняя смена', vacShiftAny: 'Смена',
